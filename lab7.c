...
void printSwapCount(nums arr[], int n) {
    int i;
    for (i = 0; i < n; i++) {
...
int main() {
    nums array1[9] = {{97, 0}, {16, 0}, {45, 0}, {63, 0}, {13, 0}, {22, 0}, {7, 0}, {58, 0}, {72, 0}};
    nums array2[9] = {{90, 0}, {80, 0}, {70, 0}, {60, 0}, {50, 0}, {40, 0}, {30, 0}, {20, 0}, {10, 0}};
    nums array1_copy[9], array2_copy[9];
